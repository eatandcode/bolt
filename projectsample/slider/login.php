      ...
      <div id="content">
        ...
        <form action="logon.php" method="get">
          <div class="form_settings">
            <p><span>Userid:</span><input type="text" name="username" value="" /></p>
            <p><span>Password:</span><input type="text" name="password" value="" /></p>
            <input class="submit" type="submit" name="name" value="Login" />&nbsp;<input class="submit" type="submit" name="name" value="Clear"/>
          </div>
        </form>
        <center><a href="registration.html">Register</a></center>
      </div>
    </div>
    <div id="footer">

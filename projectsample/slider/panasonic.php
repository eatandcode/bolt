...
<body>
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content">
        <h1>PANASONIC VIERA HDTV</h1>
        <span  style="padding:0;margin:0;"><center style="margin:0px;padding:0px;"><img src="images/panasonic.png" width="90%" style="padding:0;margin:0;"></img></center></span>
         <p> Features an advanced LED Backlight Design which produces a wider color
           ...
           the content XUMO Discovery which recommends content for you Firefox 
           OS to ensure ease for you to access smart apps and content Netflix 
           Recommended TV.</p>
         <ul>
			<li>Full HD 3D (1 Pair of Glasses Included)</li>
			<li>It has one sheet of glass design</li>
			<li>It has Infinite Black Pro 2 panel</li>
			<li>It has VIERA Connect Wi-Fi Ready</li>
			<li>It has THX 3D Certified Display </li>
         </ul>
